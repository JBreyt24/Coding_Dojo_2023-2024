...
from flask_app.controllers import user_controller, posts_controller, login_and_reg_controller #controllers go here, if you add a new controller file you have to also add it here
